...
export function Footer() {
  ...
  return (
    <footer className="border-t border-black/5 bg-surface-muted py-20 text-ink-700 transition-colors duration-300 dark:border-white/5">
      <div className="container-shell grid gap-16 lg:grid-cols-[1.2fr_1fr_1.4fr]">
        <div className="space-y-8">
          <h3 className="text-4xl font-extrabold tracking-[0.16em] text-ink-900">MDO</h3>
